...
public class Node {
    ...
    /// </summary>
    public Language Language => new(ts_tree_language(Handle.tree));
    ...
    public Node Child(int index) {
        return Create(ts_node_child(Handle, (uint)index));
    }
    ...
    public Node NamedChild(int index) {
        return Create(ts_node_named_child(Handle, (uint)index));
    }
    ...
    public Node ChildByFieldId(ushort fieldId) {
        return Create(ts_node_child_by_field_id(Handle, fieldId));
    }
