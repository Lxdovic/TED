...
public class Parser : IDisposable {
    ...
    private SafeFileHandle _dotFileHandle;
    ...
    public Language Language {
        ...
        get => new(ts_parser_language(_handle));
    }
    ...
    private unsafe Tree ParseInternal(IntPtr input, uint length, InputEncoding encoding, Tree oldTree,
