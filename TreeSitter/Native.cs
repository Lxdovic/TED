...
internal struct TsInputEdit {
    private uint start_byte;
    private uint old_end_byte;
    private uint new_end_byte;
    private TsPoint start_point;
    private TsPoint old_end_point;
    private TsPoint new_end_point;
}
