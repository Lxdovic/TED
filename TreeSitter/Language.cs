...
public class Language {
    ...
    public string SymbolName(ushort symbol) {
        return Marshal.PtrToStringAnsi(ts_language_symbol_name(Handle, symbol));
    }
    ...
    public string FieldNameForId(ushort fieldId) {
        return Marshal.PtrToStringAnsi(ts_language_field_name_for_id(Handle, fieldId));
    }
    ...
    public SymbolType SymbolType(ushort symbol) {
        return (SymbolType)ts_language_symbol_type(Handle, symbol);
    }
}
